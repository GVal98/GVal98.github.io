...
const DEFAULTS = {
  ...
  // и EA читаются как I, а сдвоенные схлопываются в одну. Пять букв заменяются
...
function refreshMorseHint() {
  ...
  $('setMorseSimpleHint').textContent =
    ...
    `Пара EA — тот же I («The Beatles» → BITLE), но кроме EAR, EAD и EATH: «Pearl Jam» и «Death Grips» остаются собой. ` +
