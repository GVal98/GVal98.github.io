...
const DEFAULTS = {
  ...
  // в одну. Пять букв заменяются созвучными (Q → K, Y → I, J → G, Z → S,
  // V → W), шестая, C, читается по соседу, как в английском: SITI, но KOLDPLAI.
  // Включена, потому что на ощупь считают знаки, а не буквы:
